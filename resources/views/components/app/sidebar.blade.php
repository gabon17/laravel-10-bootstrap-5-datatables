<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">FORMATION</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('sessions') ? 'active' : '' }}" href="{{ route('sessions') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('formateurs') ? 'active' : '' }} " href="{{ route('formateurs') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('domaines') ? 'active' : '' }}" href="{{ route('domaines') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('sujet-formation') ? 'active' : '' }}" href="{{ route('sujet-formation') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">sujet-formations</span>
                </a>
            </li>
    ...
    <li class="nav-item mt-2">
        <div class="d-flex align-items-center nav-link">
            ...
            <span class="font-weight-normal text-md ms-2">parametres</span>
        </div>
    </li>
    <li class="nav-item border-start my-0 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('liste-domaines') ? 'active' : '' }}"
            href="{{ route('liste-domaines') }}">
            <span class="nav-link-text ms-1">listes-domaines</span>
        </a>
    </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('liste-formateurs') ? 'active' : '' }}"
                   href="{{ route('liste-formateurs') }}">
                    <span class="nav-link-text ms-1">liste-formateurs</span>
                </a>
            </li>
    <li class="nav-item border-start my-0 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('liste-formations') ? 'active' : '' }}"
            href="{{ route('liste-formations') }}">
            <span class="nav-link-text ms-1">liste-formations</span>
        </a>
    </li>
    <li class="nav-item border-start my-0 pt-2">
        <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('liste-sessions') ? 'active' : '' }}"
            href="{{ route('liste-sessions') }}">
            <span class="nav-link-text ms-1">liste-sessions</span>
        </a>
    </li>
</ul>
</div>
